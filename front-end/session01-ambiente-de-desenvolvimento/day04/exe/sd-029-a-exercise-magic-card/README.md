...
1. Clone o repositório
  * `git clone git@github.com:tryber/sd-029-a-exercise-magic-card.git`.
  * Entre na pasta do repositório que você acabou de clonar:
    * `cd sd-029-a-exercise-magic-card`
...
6. Crie um novo `Pull Request` _(PR)_
  * Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-029-a-exercise-magic-card/pulls)
  ...
  * Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-029-a-exercise-magic-card/pulls) e confira que o seu _Pull Request_ está criado
