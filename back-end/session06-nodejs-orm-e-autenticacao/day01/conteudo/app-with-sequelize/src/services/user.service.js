...
const updateUser = async (id, fullName, email) => {
  ...
  console.log('erro do service update: ', updatedUser); // confira o que é retornado quando o user com o id é ou não encontrado;
  return updatedUser;
};
...
const deleteUser = async (id) => {
  ...
  console.log('erro do service delete: ', user); // confira o que é retornado quando o user com o id é ou não encontrado;
  return user;
};
